...
public enum SuccessMessage {
    ...
    QUIT_CHAT_CHANNEL_SUCCESS("채팅 채널 나가기에 성공했습니다."),
    ...
    CHAT_CHANNEL_MEMBER_INFO_RETURN_SUCCESS("채팅 채널 멤버 정보 조회에 성공 했습니다."),
    ...
    NOTIFICATION_ALL_READ_SUCCESS("알림 전체 읽기에 성공 했습니다"),
    ...
    WORK_SPACE_QUIT_SUCCESS("워크스페이스 나가기에 성공 했습니다."),
    DELETE_WORK_SPACE_SUCCESS("워크스페이스 삭제에 성공 했습니다."),
    QUIT_DIRECT_CHANNEL_SUCCESS("다이렉트 채널 나가기에 성공 했습니다."),
    ...
    DELETE_DIRECT_CHANNEL_AND_DIRECT_MESSAGE_SUCCESS("다이렉트 채널 삭제 및 연관된 채팅 메세지 삭제에 성공 했습니다."),
    CANVAS_CREATE_SUCCESS("캔버스 생성에 성공 했습니다."),
    CANVAS_LIST_RETURN_SUCCESS("캔버스 조회에 성공 했습니다."),
    CANVAS_SEARCH_LIST_RETURN_SUCCESS("캔버스 검색에 성공 했습니다."),
    UPDATE_CANVAS_SUCCESS("캔버스 수정에 성공 했습니다."),
    DELETE_CANVAS_SUCCESS("캔버스 삭제에 성공 했습니다."),
    WORK_SPACE_CONTENT_SEARCH_SUCCESS("검색에 성공했습니다.");
