...
import static org.project.nuwabackend.global.type.SuccessMessage.DELETE_DIRECT_CHANNEL_AND_CHAT_MESSAGE_SUCCESS;
...
public class ChannelAndMessageDeleteController {
    ...
    public ResponseEntity<Object> deleteChatChannelAndMessage(@PathVariable(value = "workSpaceId") Long workSpaceId,
        ...
        channelAndMessageDeleteService.deleteChatChannelAndChatMessage(workSpaceId, email, roomId);

        GlobalSuccessResponseDto<Object> deleteChatChannelAndMessageSuccessResponse =
                globalService.successResponse(DELETE_CHAT_CHANNEL_AND_CHAT_MESSAGE_SUCCESS.getMessage(), null);
    ...
    public ResponseEntity<Object> deleteDirectChannelAndMessage(@PathVariable(value = "workSpaceId") Long workSpaceId,
        ...
        channelAndMessageDeleteService.deleteDirectChannelAndDirectMessage(workSpaceId, email, roomId);

        GlobalSuccessResponseDto<Object> deleteDirectChannelAndMessageSuccessResponse =
                globalService.successResponse(DELETE_DIRECT_CHANNEL_AND_CHAT_MESSAGE_SUCCESS.getMessage(), null);
