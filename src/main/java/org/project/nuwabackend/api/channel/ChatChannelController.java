...
public class ChatChannelController {
    ...
    public ResponseEntity<Object> createChatChannel(@MemberEmail String email, ChatChannelRequest chatChannelRequest) {
    ...
    public ResponseEntity<Object> joinChatChannel(ChatChannelJoinMemberRequest chatChannelJoinMemberRequest) {
